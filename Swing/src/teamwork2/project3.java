...
combo.setModel(new DefaultComboBoxModel(new String[] {"Kerala", "Tamil Nadu", "karnataka"}));
combo.setBounds(10, 230, 78, 20);
frame.getContentPane().add(combo);

JComboBox comboBox_1 = new JComboBox();
comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Kerala", "TamilNadu", "gujarat"}));
...
panel_1.setBounds(10, 472, 612, 86);
...
panel_2.setBounds(196, 11, 315, 77);
frame.getContentPane().add(panel_2);
panel_2.setLayout(null);

JLabel lblTicketBooking = new JLabel("Ticket Booking");
lblTicketBooking.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 25));
lblTicketBooking.setBounds(72, 11, 177, 38);
